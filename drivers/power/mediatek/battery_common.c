...
static void mt_battery_Sync_UI_Percentage_to_Real(void)
{
	...
	if ((BMT_status.UI_SOC > BMT_status.SOC) && ((BMT_status.UI_SOC != 1))) {
		...
		#if !defined(CUST_CAPACITY_OCV2CV_TRANSFORM)
		//qiantao 20151223 begin
		#if 0
		//qiantao 20151116 begin
		...
		//qiantao 20151116 end
		#endif
		BMT_status.UI_SOC = BMT_status.SOC;
		//qiantao 20151223 end
		#else
...
//xuzhifeng 20150724 modify battery temperature check notify begin
...
#else
	if(BMT_status.temperature >= MAX_CHARGE_TEMPERATURE  && BMT_status.temperature <= 57)
...
#else
//xuzhifeng 20150724 modify battery temperature check notify end
static void mt_battery_notify_VBatTemp_check(void)
{
#if defined(BATTERY_NOTIFY_CASE_0002_VBATTEMP)
