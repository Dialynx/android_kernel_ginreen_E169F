...
#if !defined(CONFIG_MTK_JEITA_STANDARD_SUPPORT)
#ifdef HIGH_BATTERY_VOLTAGE_SUPPORT
        //xuzhifeng 20150818 begin
        #ifdef CONFIG_WIND_BATTERY_MODIFY_V310F
        	cv_voltage = BATTERY_VOLT_04_325000_V;
        #else
			cv_voltage = BATTERY_VOLT_04_350000_V;
        #endif
        //xuzhifeng 20150818 end
#else
			cv_voltage = BATTERY_VOLT_04_200000_V;
#endif
			battery_charging_control(CHARGING_CMD_SET_CV_VOLTAGE, &cv_voltage);
...
//qiantao 20150923 end
	...
	{
		BMT_status.bat_charging_state = CHR_CC;
		battery_log(BAT_LOG_CRTI, "[BATTERY] BAD Battery status... Charging Start!!\n\r");
