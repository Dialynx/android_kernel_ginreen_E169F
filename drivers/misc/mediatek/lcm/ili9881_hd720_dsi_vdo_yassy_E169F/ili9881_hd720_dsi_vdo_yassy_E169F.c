...
//  Local Functions
// ---------------------------------------------------------------------------
//tuwenzan modify at 20150819 begin
#ifdef CONFIG_WIND_LCD_POWER_SUPPLY_SUPPORT
extern int tps65132_write_bytes(unsigned char addr, unsigned char value);
#endif
//tuwenzan modify at 20150819 end
...
// To fix rf
		params->dsi.PLL_CLOCK = 212;	   // 245; tuwenzan modify at 20150922
...
//#endif
#endif
//tuwenzan add at 20150820 begin 
...
printk("xuecheng0 lcm_status= %d\n",lcm_status);
	...
	//tuwenzan modify at 20150819 begin
     //mt_set_gpio_mode(GPIO_LCM_PWR_EN, GPIO_MODE_00);
	//mt_set_gpio_dir(GPIO_LCM_PWR_EN, GPIO_DIR_OUT);
	//mt_set_gpio_out(GPIO_LCM_PWR_EN, GPIO_OUT_ZERO);	//	GPIO_OUT_ONE	tuwenzan modify at 20150805
    //tuwenzan modify at 20150819 end
	MDELAY(10);
