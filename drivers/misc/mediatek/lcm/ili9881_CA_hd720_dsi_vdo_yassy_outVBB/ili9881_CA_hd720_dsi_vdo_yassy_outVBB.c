...
static unsigned int lcm_compare_id(void)
{
   ...
   // array[2]=0x00000007;
    ...
    #ifdef BUILD_LK
		printf("%s, LK ili9881-CA debug: ili9881 id = %x,%x,%x\n", __func__, id,id1,id2);
    #else
		printk("%s, kernel ili9881-CA horse debug: ili9881 id = 0x%08x\n", __func__, id);
    #endif
//return 1;
...
LCM_DRIVER ili9881_CA_hd720_dsi_vdo_yassy_outVBB_lcm_drv =
{
    .name           	= "ili9881_CA_hd720_dsi_vdo_yassy_outVBB",
