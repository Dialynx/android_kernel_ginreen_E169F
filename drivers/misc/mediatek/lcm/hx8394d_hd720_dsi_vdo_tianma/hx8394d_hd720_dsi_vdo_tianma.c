//guohongjin 20150716 add tianma lcd code begin
#ifndef BUILD_LK
...
static void init_lcm_registers(void)
{
    ...
    printf( "[LK][darren-hx8394d] ----init_lcm_registers----\n");    	
	  		
#else
	
	printk("[KERNEL][darren-hx8394d] ----init_lcm_registers----\n");
#endif
	...
	data_array[1]=0x12126CB1;//VSPR=4.8V
	data_array[2]=0xF1110426;//vgl=-5.55*2
	...
	data_array[1]=0x1A1604E0;
	data_array[2]=0x233F3B3A;//	data_array[2]=0x1A332924;
	data_array[3]=0x0D0B073D;//	data_array[3]=0x0D0B083C;
	data_array[4]=0x14110E18;//	data_array[4]=0x15120F17;
	data_array[5]=0x0D061310;
	data_array[6]=0x16041711;
	data_array[7]=0x3F3B3A1A;   
	data_array[8]=0x0B073D23;//	data_array[8]=0x0B083C1A;
	data_array[9]=0x110E180D;//	data_array[9]=0x120F170D;
	data_array[10]=0x06131014;//	data_array[10]=0x08141315;
	data_array[11]=0x0017110D;
	dsi_set_cmdq(data_array, 12, 1);
	MDELAY(1);

       data_array[0]=0x00033902;
       data_array[1]=0x006060b6;//VCOM
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);
	...
	data_array[0]=0x00023902;
	data_array[1]=0x000022D2;//VPREF=4.8V
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);
	...
	data_array[0]=0x00053902;
       data_array[1]=0x83FFB9BF;
	data_array[2]=0x00000094;
	dsi_set_cmdq(data_array, 3, 1);
	MDELAY(20);

	data_array[0]=0x00033902;
       data_array[1]=0x000003BC;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);

	data_array[0]=0x00043902;
       data_array[1]=0x8373BABF;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(5);

	data_array[0]=0x00033902;
       data_array[1]=0x000010BC;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);

	data_array[0]=0x00113902;
       data_array[1]=0x126CB1BF;
	data_array[2]=0x11042612;
	data_array[3]=0x543A81F1;
	data_array[4]=0xD2C08023;
	data_array[5]=0x00000058;
	dsi_set_cmdq(data_array, 6, 1);
	MDELAY(5);

	data_array[0]=0x00033902;
       data_array[1]=0x00000CBC;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);

	data_array[0]=0x000D3902;
       data_array[1]=0x6400B2BF;
	data_array[2]=0x1C220D0E;
	data_array[3]=0x4D1C0808;
	data_array[4]=0x00000000;
	dsi_set_cmdq(data_array, 5, 1);
	MDELAY(20);

	data_array[0]=0x00033902;
       data_array[1]=0x00000DBC;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);

	data_array[0]=0x000E3902;
       data_array[1]=0xFF00B4BF;
	data_array[2]=0x5A595A51;
	data_array[3]=0x70015A03;
	data_array[4]=0x00006020;
	dsi_set_cmdq(data_array, 5, 1);
	MDELAY(20);
	...
	data_array[0]=0x00053902;
       data_array[1]=0x0E41BFBF;
	data_array[1]=0x00000001;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(5);
	
	data_array[0]=0x00033902;
       data_array[1]=0x00001FBC;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);

	data_array[0]=0x00203902;
       data_array[1]=0x0F00D3BF;
	data_array[2]=0x10074000;
	...
	data_array[0]=0x00033902;
       data_array[1]=0x00002DBC;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);

	data_array[0]=0x002E3902;
       data_array[1]=0x1A1AD5BF;
	data_array[2]=0x01001B1B;
       data_array[3]=0x05040302;
	data_array[4]=0x09080706;      
	data_array[5]=0x25240B0A;
       data_array[6]=0x27261818;
	data_array[7]=0x18181818;
	data_array[8]=0x18181818;
	data_array[9]=0x18181818;
	data_array[10]=0x18181818;
	data_array[11]=0x18182120;
	data_array[12]=0x00001818;
	dsi_set_cmdq(data_array, 13, 1);
	MDELAY(5);
	...
	data_array[0]=0x002E3902;
       data_array[1]=0x1A1AD6BF;
	data_array[2]=0x090A1B1B;
       data_array[3]=0x05060708;
	data_array[4]=0x01020304;     
	data_array[5]=0x58202100;
       data_array[6]=0x18262758;
	...
	data_array[9]=0x18181818;
	data_array[10]=0x18181818;
	data_array[11]=0x18182425;
	data_array[12]=0x00001818;
	dsi_set_cmdq(data_array, 13, 1);
	MDELAY(5);

	data_array[0]=0x00033902;
       data_array[1]=0x00002BBC;
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);

	data_array[0]=0x002C3902;
       data_array[1]=0x1604E0BF;
	data_array[2]=0x3F3B3A1A;
	data_array[3]=0x0B073D23;     
	data_array[4]=0x110E180D;
       data_array[5]=0x06131014;
	data_array[6]=0x0417110D;
	data_array[7]=0x3B3A1A16;
	data_array[8]=0x073D233F;
	data_array[9]=0x0E180D0B;
	data_array[10]=0x13101411;
	data_array[11]=0x17110D06;
	dsi_set_cmdq(data_array, 12, 1);
	MDELAY(5);
	...
	data_array[0]=0x00063902;
       data_array[1]=0xC000C7BF;
	data_array[2]=0x0000C040;
	dsi_set_cmdq(data_array, 3, 1);
	MDELAY(5);
...
//data=0x0A;VSP=5V,//data=0x0E;VSP=5.4V
    ...
    printf( "[LK][darren-hx8394d] ----lcm_init----\n");    	
	  		
#else
	
	printk("[KERNEL][darren-hx8394d] ----lcm_init----\n");
#endif
...
static unsigned int lcm_compare_id(void)
{
	...
	data_array[0]= 0x00033902;
	data_array[1]= (0x83<<16)|(0x73<<8)|0xba;
	dsi_set_cmdq(data_array, 2, 1);
	...
	dsi_set_cmdq(data_array, 1, 1);
       ...
       //DA=0X83,DB=0X94,DC=0X0D
	read_reg_v2(0xDB, &buffer, 1);//94
...
//guohongjin 20150716 add tianma lcd code end
