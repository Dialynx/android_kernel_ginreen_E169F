...
//tuwenzan modify at 20151204  begin
...
//tuwenzan modify at 20151204  end
...
//zhounengwen 20140820 end
	...
	//tuwenzan modify at 20150923  begin			
		  params->dsi.lcm_esd_check_table[1].cmd                  = 0x0d;
                params->dsi.lcm_esd_check_table[1].count                = 1;
                params->dsi.lcm_esd_check_table[1].para_list[0] = 0x00;
   //tuwenzan modify at 20150923  end
}
	//zhangaifeng begin
//#ifndef BUILD_LK
...
*/
	...
	cmd=0x03;
	data=0x0;
	//tuwenzan add this at 20150805 begin
...
//	mt_set_gpio_out(GPIO_LCM_PWR_EN, GPIO_OUT_ONE);
	MDELAY(10);
  //tuwenzan add this at 20150805 end
	#ifdef BUILD_LK
