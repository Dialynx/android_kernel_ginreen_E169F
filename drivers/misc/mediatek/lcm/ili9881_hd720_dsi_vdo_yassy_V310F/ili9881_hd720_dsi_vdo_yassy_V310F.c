...
{0x78,1,{0x04}},		//VGL pumping ratio 2x

{0x74,1,{0x2B}},		//VGH clamp 15V
{0x8E,1,{0x1F}},		//VGL clamp -12V
...
{0x22,1,{0x0A}},		//BGR, SS
{0x53,1,{0x96}},		//VCOM1   90
{0x55,1,{0x78}},		//VCOM2
{0x50,1,{0x96}},         	//VREG1OUT=4.7V  A3
{0x51,1,{0xA0}},       	//VREG2OUT=-4.7V  A3
...
LCM_DRIVER ili9881_hd720_dsi_vdo_yassy_V310F_lcm_drv =
{
    .name           	= "ili9881_hd720_dsi_vdo_yassy_V310F",
