...
static void init_lcm_registers(void)
{
	...
	//TC358768_DCS_write_1A_1P(0xFF, 0x05);	//0xFF为地址，0x05为参数；
	...
	TC358768_DCS_write_1A_1P(0x7C, 0x31);	//0x31

	TC358768_DCS_write_1A_1P(0xFF, 0x01);
	TC358768_DCS_write_1A_1P(0xFB, 0x01);
	TC358768_DCS_write_1A_1P(0x00, 0x01);
	TC358768_DCS_write_1A_1P(0x01, 0x33);   //55
	TC358768_DCS_write_1A_1P(0x02, 0x20);   //40
	TC358768_DCS_write_1A_1P(0x05, 0x50);	//50  0x40	//dzl temp
	TC358768_DCS_write_1A_1P(0x06, 0x4A);
	TC358768_DCS_write_1A_1P(0x07, 0x24);	//0x3c
	TC358768_DCS_write_1A_1P(0x08, 0x0C);
	TC358768_DCS_write_1A_1P(0x0B, 0x7D);	//0x9B
	TC358768_DCS_write_1A_1P(0x0C, 0x7D);	//0x9B
	TC358768_DCS_write_1A_1P(0x0E, 0xB0);	//0XB6
	TC358768_DCS_write_1A_1P(0x0F, 0xAE);	//0XB5
	TC358768_DCS_write_1A_1P(0x11, 0x10);	//0X28
	TC358768_DCS_write_1A_1P(0x12, 0x10);	//0X28
	TC358768_DCS_write_1A_1P(0x13, 0x03);
	TC358768_DCS_write_1A_1P(0x14, 0x4A);
	TC358768_DCS_write_1A_1P(0x15, 0x12);	//0X18
	TC358768_DCS_write_1A_1P(0x16, 0x12);	//0X18
	TC358768_DCS_write_1A_1P(0x18, 0x00);
	...
	TC358768_DCS_write_1A_1P(0x1E, 0x00);	//0x13	//0X00
	...
	TC358768_DCS_write_1A_1P(0x54, 0x75);//77
	...
	TC358768_DCS_write_1A_1P(0x80, 0x00);	//0x81
	TC358768_DCS_write_1A_1P(0x83, 0x00);	//0x05
	TC358768_DCS_write_1A_1P(0x93, 0x08);
	TC358768_DCS_write_1A_1P(0x94, 0x10);
	TC358768_DCS_write_1A_1P(0x8A, 0x00);	//0x21	//0x33	//0x00
	...
	TC358768_DCS_write_1A_1P(0x1F,0x2E);
	TC358768_DCS_write_1A_1P(0x20,0x03);
	TC358768_DCS_write_1A_1P(0x21,0x3B);
	TC358768_DCS_write_1A_1P(0x22,0x03);
	TC358768_DCS_write_1A_1P(0x23,0x49);
	TC358768_DCS_write_1A_1P(0x24,0x03);
	TC358768_DCS_write_1A_1P(0x25,0x59);
	...
	TC358768_DCS_write_1A_1P(0x2B,0x8D);
	...
	TC358768_DCS_write_1A_1P(0x60,0x2E);
	TC358768_DCS_write_1A_1P(0x61,0x03);
	TC358768_DCS_write_1A_1P(0x62,0x3B);
	TC358768_DCS_write_1A_1P(0x63,0x03);
	TC358768_DCS_write_1A_1P(0x64,0x49);
	TC358768_DCS_write_1A_1P(0x65,0x03);
	TC358768_DCS_write_1A_1P(0x66,0x59);
	...
	TC358768_DCS_write_1A_1P(0x6C,0x8D);
	...
	TC358768_DCS_write_1A_1P(0x74,0x0A);
	TC358768_DCS_write_1A_1P(0x75,0x00);
	TC358768_DCS_write_1A_1P(0x76,0x2A);
	...
	TC358768_DCS_write_1A_1P(0xBA,0x69);
	TC358768_DCS_write_1A_1P(0xBB,0x00);
	TC358768_DCS_write_1A_1P(0xBC,0x7A);
	TC358768_DCS_write_1A_1P(0xBD,0x00);
	TC358768_DCS_write_1A_1P(0xBE,0x8A);
	TC358768_DCS_write_1A_1P(0xBF,0x00);
	TC358768_DCS_write_1A_1P(0xC0,0x98);
	TC358768_DCS_write_1A_1P(0xC1,0x00);
	TC358768_DCS_write_1A_1P(0xC2,0xCB);
	TC358768_DCS_write_1A_1P(0xC3,0x00);
	TC358768_DCS_write_1A_1P(0xC4,0xF5);
	TC358768_DCS_write_1A_1P(0xC5,0x01);
	TC358768_DCS_write_1A_1P(0xC6,0x38);
	TC358768_DCS_write_1A_1P(0xC7,0x01);
	TC358768_DCS_write_1A_1P(0xC8,0x6E);
	TC358768_DCS_write_1A_1P(0xC9,0x01);
	TC358768_DCS_write_1A_1P(0xCA,0xC2);
	TC358768_DCS_write_1A_1P(0xCB,0x02);
	TC358768_DCS_write_1A_1P(0xCC,0x03);
	TC358768_DCS_write_1A_1P(0xCD,0x02);
	TC358768_DCS_write_1A_1P(0xCE,0x05);
	TC358768_DCS_write_1A_1P(0xCF,0x02);
	TC358768_DCS_write_1A_1P(0xD0,0x3D);
	TC358768_DCS_write_1A_1P(0xD1,0x02);
	TC358768_DCS_write_1A_1P(0xD2,0x75);
	TC358768_DCS_write_1A_1P(0xD3,0x02);
	TC358768_DCS_write_1A_1P(0xD4,0x98);
	TC358768_DCS_write_1A_1P(0xD5,0x02);
	TC358768_DCS_write_1A_1P(0xD6,0xC7);
	TC358768_DCS_write_1A_1P(0xD7,0x02);
	TC358768_DCS_write_1A_1P(0xD8,0xE8);
	TC358768_DCS_write_1A_1P(0xD9,0x03);
	TC358768_DCS_write_1A_1P(0xDA,0x14);
	TC358768_DCS_write_1A_1P(0xDB,0x03);
	TC358768_DCS_write_1A_1P(0xDC,0x21);
	TC358768_DCS_write_1A_1P(0xDD,0x03);
	TC358768_DCS_write_1A_1P(0xDE,0x30);
	TC358768_DCS_write_1A_1P(0xDF,0x03);
	TC358768_DCS_write_1A_1P(0xE0,0x41);
	TC358768_DCS_write_1A_1P(0xE1,0x03);
	TC358768_DCS_write_1A_1P(0xE2,0x53);
	TC358768_DCS_write_1A_1P(0xE3,0x03);
	TC358768_DCS_write_1A_1P(0xE4,0x68);
	TC358768_DCS_write_1A_1P(0xE5,0x03);
	TC358768_DCS_write_1A_1P(0xE6,0x80);
	TC358768_DCS_write_1A_1P(0xE7,0x03);
	TC358768_DCS_write_1A_1P(0xE8,0x90);
	TC358768_DCS_write_1A_1P(0xE9,0x03);
	TC358768_DCS_write_1A_1P(0xEA,0xCB);

	//FOR PWM SETTING
	TC358768_DCS_write_1A_1P(0xFF,0x04);
	TC358768_DCS_write_1A_1P(0xFB,0x01);
	//TC358768_DCS_write_1A_1P(0x07,0x00);
	TC358768_DCS_write_1A_1P(0x08,0xFF);
	...
	TC358768_DCS_write_1A_1P(0x51,0x08);
	TC358768_DCS_write_1A_1P(0x53,0x2C);
	//TC358768_DCS_write_1A_1P(0x55,0x00);
	//TC358768_DCS_write_1A_1P(0x55,0x10);//IE_OFF	//dongzhonglin for s610 contrast 
	//TC358768_DCS_write_1A_1P(0x55,0x80);//IE_LOW
	//TC358768_DCS_write_1A_1P(0x55,0x90);//IE_MEDIUM
	TC358768_DCS_write_1A_1P(0x55,0xE0);//IE_HIGH
#else

TC358768_DCS_write_1A_1P(0x01, 0x00); //fix bug 
MDELAY(120);

TC358768_DCS_write_1A_1P(0xFF,0xEE);            //0828 modified 
TC358768_DCS_write_1A_1P(0xFB,0x01);            //0828 modified 
TC358768_DCS_write_1A_1P(0x18,0x40);            //0828 modified 
MDELAY(10);                                     //0828 modified 
TC358768_DCS_write_1A_1P(0x18,0x00);            //0828 modified 
MDELAY(20);   //0828 modified 
...
//Delay	>20ms
  ...
  TC358768_DCS_write_1A_1P(0xFF,0xEE);
  TC358768_DCS_write_1A_1P(0xFB,0x01);
  TC358768_DCS_write_1A_1P(0x24,0x26);
...
static void lcm_get_params(LCM_PARAMS * params) //VSA=2 VBP=8 VFP=10
{
	...
	params->dsi.horizontal_backporch = 90;//110;//100;//110;//100;//127;
	params->dsi.horizontal_frontporch = 90;//110;//95;//104;//100;//104;
	params->dsi.horizontal_active_pixel = FRAME_WIDTH;
	//params->dsi.pll_select=1;     //0: MIPI_PLL; 1: LVDS_PLL
	// Bit rate calculation
	//1 Every lane speed
	params->dsi.PLL_CLOCK = 480;//470;//450;//500;
...
static void lcm_suspend(void)
{
  ...
  MDELAY(20); 
	...
	SET_RESET_PIN(0);
	MDELAY(10);
	lcm_util.set_gpio_out(GPIO_LCD_BIAS_ENP_PIN, GPIO_OUT_ZERO);		//dongzhonglin reduce consumption   temp modify  20140214
...
#ifdef BUILD_LK
	printf("%s, LK nt35596 yassy auo debug: nt35596 0x%08x\n", __func__,
	       id);
#else
	printk("%s,kernel nt35596 yassy auo horse debug: nt35596 id = 0x%08x\n",
	       __func__, id);
#endif

extern unsigned char which_lcd_module_triple_cust(void);
	if (id == LCM_ID_NT35596){
		id = which_lcd_module_triple_cust();
		if(id == 0x11)
		{
			return 1;
		   	}else{
...
static unsigned int lcm_esd_check(void)
{
    ...
    #ifdef BUILD_LK
		printf("%s, LK nt35596 debug: nt35596 0x0A = 0x%08x\n", __func__, id);
    #else
		printk("%s, kernel nt35596 horse debug: nt35596 0x0A= 0x%08x\n", __func__, id);
    #endif

//	return 0;
	
	if(id == 0x08  || id == 0x96 || id == 0x9c)
	{
	   return 0;
	}
	else
...
LCM_DRIVER nt35596_fhd_dsi_vdo_yassy_auo_lcm_drv = {
	.name = "nt35596_fhd_dsi_vdo_yassy_auo",
