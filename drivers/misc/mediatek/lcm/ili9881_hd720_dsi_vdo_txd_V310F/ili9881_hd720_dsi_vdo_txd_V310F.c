...
/* BEGIN PN: , Added by liuepng, 2015.07.16*/
#ifndef BUILD_LK
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//	params->dsi.noncont_clock_period=2;
		...
		params->dsi.horizontal_backporch				= 120;  //60  
...
// To fix boot error
//		params->dsi.PLL_CLOCK = 240;   //245
//		modify by liupeng 20150818 begin
		params->dsi.PLL_CLOCK = 235;   //245
		params->dsi.ssc_disable =1 ;
//		modify by liupeng 20150818 end
...
LCM_DRIVER ili9881_hd720_dsi_vdo_txd_V310F_lcm_drv =
{
    .name           	= "ili9881_hd720_dsi_vdo_txd_V310F",
