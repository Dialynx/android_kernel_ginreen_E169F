...
//tuwenzan modify at 20151118 begin (refer to FAQ)
int ddp_dsi_build_cmdq(DISP_MODULE_ENUM module, void *cmdq_trigger_handle, CMDQ_STATE state)
{
   ...
   {
				printk("esd_check1: %#x, %#x, %#x, %#x, %#x, %#x", read_data1.byte0, dsi_params->lcm_esd_check_table[i].para_list[0], read_data1.byte1,dsi_params->lcm_esd_check_table[i].para_list[1]
					, read_data1.byte2,dsi_params->lcm_esd_check_table[i].para_list[2]);
    ret = 1; // esd fail
    break;
   }
