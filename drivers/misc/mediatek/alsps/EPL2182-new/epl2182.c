...
// modify by liupeng 20150806 begin
#if defined(CONFIG_WIND_DEF_PRO_V310F) //Only for A310L ||V310F 
#define DYN_H_OFFSET 	 	1300//400
#define DYN_L_OFFSET		1000//300
#else
#define DYN_H_OFFSET 	 	400//400
#define DYN_L_OFFSET		300//300
// modify by liupeng 20150806 end
#endif
#endif
//liqiang 20140924 add end 
