...
{
    kal_uint32 val=0;
   //liqiang 20150716 begin
   // val = mt6325_upmu_get_rgs_chrdet();
	val = pmic_get_register_value(PMIC_RGS_CHRDET);
	//liqiang 20150716 end
...
static kal_uint32 charging_hw_init(void *data)
{
    ...
    bq24261_config_interface(bq24261_CON5, 0x5, 0x7, 0); // VINDPM
...
static kal_uint32 charging_set_cv_voltage(void *data)
{
    ...
    #if 1 //liqiang 20150716 modified this to fix compiling error (refer to charging_hw_pmic.c)
...
static kal_uint32 charging_set_hv_threshold(void *data)
{
	...
	//liqiang 20150716 modified this to fix compiling error (refer to charging_hw_pmic.c)
...
static kal_uint32 charging_get_charger_det_status(void *data)
{
	...
	//liqiang 20150716 begin
    //val = mt6325_upmu_get_rgs_chrdet();
    val = bc11_get_register_value(PMIC_RGS_CHRDET);
	//liqiang 20150716 end
    #else
...
static kal_uint32 charging_set_ta_current_pattern(void *data)
{
	...
	//liqiang 20150825 begin	
	#elif defined (HIGH_4_4V_BATTERY_VOLTAGE_SUPPORT)
	BATTERY_VOLTAGE_ENUM cv_voltage = BATTERY_VOLT_04_400000_V;
	//liqiang 20150825 end
    #else
