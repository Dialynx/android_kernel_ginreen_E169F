...
//	char bufR[2];
//cost down mode
// modify by liupeng 20151111 begin
PK_DBG("liupeng write datadddddd\n");
#if 1
	if(g_duty==0){
//troch mode 
	val=1;
	...
	buf[0]=9;
	buf[1]=val;
	PK_DBG("liupeng write 11 data=%d\n",buf[1]);
	//iWriteRegI2C(buf , 2, STROBE_DEVICE_ID);
	LM3642_write_reg(LM3642_i2c_client, buf[0], buf[1]);
...
// modify by liupeng 20151111 end
