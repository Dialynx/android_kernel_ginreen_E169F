...
int FL_Enable(void)
{
	//liuying 20131225 for flashlight not light in strong light begin
	//mt_set_gpio_out(GPIO_ENT,GPIO_OUT_ZERO);
	mt_set_gpio_out(GPIO_ENF,GPIO_OUT_ONE);
	PK_DBG(" FL_Enable line=%d\n",__LINE__);
	//liuying 20131225 for flashlight not light in strong light end
