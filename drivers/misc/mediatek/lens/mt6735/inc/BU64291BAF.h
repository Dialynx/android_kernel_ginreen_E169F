...
*/
#ifndef _BU64291BAF_H
#define _BU64291BAF_H

#include <linux/ioctl.h>
/* #include "kd_imgsensor.h" */

#define BU64291BAF_MAGIC 'A'
...
#define BU64291BAFIOC_G_MOTORINFO _IOR(BU64291BAF_MAGIC, 0, stBU64291BAF_MotorInfo)

#define BU64291BAFIOC_T_MOVETO _IOW(BU64291BAF_MAGIC, 1, u32)

#define BU64291BAFIOC_T_SETINFPOS _IOW(BU64291BAF_MAGIC, 2, u32)

#define BU64291BAFIOC_T_SETMACROPOS _IOW(BU64291BAF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define BU64291BAFIOC_G_MOTORMETAINFO _IOR(BU64291BAF_MAGIC, 4, stBU64291BAF_MotorMETAInfo)
#endif
