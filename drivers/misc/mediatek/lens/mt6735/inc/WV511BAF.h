...
#define WV511BAFIOC_G_MOTORINFO _IOR(WV511BAF_MAGIC, 0, stWV511BAF_MotorInfo)

#define WV511BAFIOC_T_MOVETO _IOW(WV511BAF_MAGIC, 1, u32)

#define WV511BAFIOC_T_SETINFPOS _IOW(WV511BAF_MAGIC, 2, u32)

#define WV511BAFIOC_T_SETMACROPOS _IOW(WV511BAF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define WV511BAFIOC_G_MOTORMETAINFO _IOR(WV511BAF_MAGIC, 4, stWV511BAF_MotorMETAInfo)
#endif
