...
#define WV511AFIOC_G_MOTORINFO _IOR(WV511AF_MAGIC, 0, stWV511AF_MotorInfo)

#define WV511AFIOC_T_MOVETO _IOW(WV511AF_MAGIC, 1, u32)

#define WV511AFIOC_T_SETINFPOS _IOW(WV511AF_MAGIC, 2, u32)

#define WV511AFIOC_T_SETMACROPOS _IOW(WV511AF_MAGIC, 3, u32)
#ifdef LensdrvCM3
#define WV511AFIOC_G_MOTORMETAINFO _IOR(WV511AF_MAGIC, 4, stWV511AF_MotorMETAInfo)
#endif
