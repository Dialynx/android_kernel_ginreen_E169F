...
#define AF_DRVNAME "BU64291AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x30
#define PLATFORM_DRIVER_NAME "lens_actuator_bu64291af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_bu64291af"
...
inline static int getAFInfo(__user stBU64291AF_MotorInfo * pstMotorInfo)
{
    stBU64291AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stBU64291AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stBU64291AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stBU64291AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stBU64291AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case BU64291AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stBU64291AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case BU64291AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stBU64291AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case BU64291AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case BU64291AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case BU64291AFIOC_T_SETMACROPOS :
...
static int AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
   ...
   //liuying 20140428 open ISRC begin
	#if 0
	char puSendCmd[2]={(char)(0xA8),(char)(0x4D)};//2a?¡ìo????¡ì2??
    if (i4RetValue < 0) 
    {
...
static int __init BU64291AF_i2C_init(void)
{
...
static void __exit BU64291AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(BU64291AF_i2C_init);
module_exit(BU64291AF_i2C_exit);

MODULE_DESCRIPTION("BU64291AF lens module driver");
