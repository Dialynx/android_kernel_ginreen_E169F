...
#define AF_DRVNAME "BU64291BAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x32
#define PLATFORM_DRIVER_NAME "lens_actuator_bu64291baf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_bu64291baf"
...
static int s4AF_WriteReg(u16 a_u2Data)
{
    ...
    char puSendCmd[2] = {(char)(a_u2Data >> 8)&0x03|0xF4 , (char)(a_u2Data & 0xff )};//liuying 20140428 open ISRC 
...
inline static int getAFInfo(__user stBU64291BAF_MotorInfo * pstMotorInfo)
{
    stBU64291BAF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stBU64291BAF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stBU64291BAF_MotorMETAInfo * pstMotorMETAInfo)
{
    stBU64291BAF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stBU64291BAF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case BU64291BAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stBU64291BAF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case BU64291BAFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stBU64291BAF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case BU64291BAFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case BU64291BAFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case BU64291BAFIOC_T_SETMACROPOS :
...
{
    int  i4RetValue = 0;//liuying 20140428 open ISRC 
    LOG_INF("Start \n");
    ...
    g_s4AF_Opened = 1;
    spin_unlock(&g_AF_SpinLock);
   //liuying 20140428 open ISRC begin
	#if 0
	char puSendCmd[2]={(char)(0xA8),(char)(0x4D)};//2a??¡§?o?????¡§?2??
    if (i4RetValue < 0) 
    {
        LOG_INF("[BU64291AF] I2C send failed!! \n");
        return -1;
    }
	#else
	char puSendCmd1[2]={(char)(0x94),(char)(0x69)};//A point=100d 
	char puSendCmd2[2]={(char)(0x9C),(char)(0x91)};//B point=130d //liuying 20140430 modify 
	char puSendCmd3[2]={(char)(0xA4),(char)(0x21)};//A-B point step mode:50us/1Lsd 
	char puSendCmd4[2]={(char)(0x8C),(char)(0x43)};//85Hz,Fast mode
...
#endif
	//liuying 20140428 open ISRC end
...
static int __init BU64291BAF_i2C_init(void)
{
...
static void __exit BU64291BAF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(BU64291BAF_i2C_init);
module_exit(BU64291BAF_i2C_exit);

MODULE_DESCRIPTION("BU64291BAF lens module driver");
MODULE_AUTHOR("KY Chen <ky.chen@Mediatek.com>");
MODULE_LICENSE("GPL");

/*
	liuying 20150720 add end
*/
