...
#define AF_DRVNAME "WV511AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x30
#define PLATFORM_DRIVER_NAME "lens_actuator_wv511af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_wv511af"
...
inline static int getAFInfo(__user stWV511AF_MotorInfo * pstMotorInfo)
{
    stWV511AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stWV511AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stWV511AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stWV511AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stWV511AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case WV511AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stWV511AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case WV511AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stWV511AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case WV511AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case WV511AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case WV511AFIOC_T_SETMACROPOS :
...
static int __init WV511AF_i2C_init(void)
{
...
static void __exit WV511AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(WV511AF_i2C_init);
module_exit(WV511AF_i2C_exit);

MODULE_DESCRIPTION("WV511AF lens module driver");
MODULE_AUTHOR("KY Chen <ky.chen@Mediatek.com>");
MODULE_LICENSE("GPL");


/*
	hebiao 20151204 add end
*/