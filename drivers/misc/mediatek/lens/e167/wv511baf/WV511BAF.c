...
#define AF_DRVNAME "WV511BAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x32
#define PLATFORM_DRIVER_NAME "lens_actuator_wv511baf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_wv511baf"
...
inline static int getAFInfo(__user stWV511BAF_MotorInfo * pstMotorInfo)
{
    stWV511BAF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stWV511BAF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stWV511BAF_MotorMETAInfo * pstMotorMETAInfo)
{
    stWV511BAF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stWV511BAF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case WV511BAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stWV511BAF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case WV511BAFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stWV511BAF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case WV511BAFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case WV511BAFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case WV511BAFIOC_T_SETMACROPOS :
...
static int __init WV511BAF_i2C_init(void)
{
...
static void __exit WV511BAF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(WV511BAF_i2C_init);
module_exit(WV511BAF_i2C_exit);

MODULE_DESCRIPTION("WV511BAF lens module driver");
