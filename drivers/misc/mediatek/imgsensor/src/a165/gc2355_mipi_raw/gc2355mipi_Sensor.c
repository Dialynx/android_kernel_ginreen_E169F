...
static imgsensor_info_struct imgsensor_info = {
  ...
  //  .checksum_value = 0xffd8e112,        //checksum value for Camera Auto Test
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,//sensor output first pixel color  //liuying 20150303
    .mclk = 24,//mclk value, suggest 24 or 26 for 24Mhz or 26Mhz
    .mipi_lane_num = SENSOR_MIPI_2_LANE,//mipi lane num
    .i2c_addr_table = {0x79, 0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
};


static imgsensor_struct imgsensor = {
    .mirror = IMAGE_HV_MIRROR,                //mirrorflip information //add by hebiao
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17,0x17);//14   //liuying 20150303
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    set_mirror_flip(sensor_config_data->SensorImageMirror); //add by hebiao 
    return ERROR_NONE;
}    /*    preview   */
