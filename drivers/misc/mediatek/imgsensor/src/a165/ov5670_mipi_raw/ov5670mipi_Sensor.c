...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x3820, 0x96);  // modified by hebiao 20151228						  
	write_cmos_sensor(0x3821, 0x41);  // modified by hebiao 20151228							  
	...
	write_cmos_sensor(0x450a, 0x00);
	write_cmos_sensor(0x450b, 0x20);   // 	modified by hebiao 20151228
	write_cmos_sensor(0x4600, 0x00);  // 							  
	write_cmos_sensor(0x4601, 0x81);  // 							  
	write_cmos_sensor(0x4017, 0x10);  //; threshold = 4LSB for Binning 
	write_cmos_sensor(0x4837, 0x11);        //modified by hebiao 20151228
