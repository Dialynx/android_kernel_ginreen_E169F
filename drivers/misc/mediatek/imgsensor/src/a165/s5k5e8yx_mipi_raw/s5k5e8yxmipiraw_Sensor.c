...
static imgsensor_struct imgsensor = {
	.mirror = IMAGE_HV_MIRROR,  			//mirrorflip information //add by hebiao 20151215
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x3400,0x00); //shade_bypass LSC on liukun 20151125
	write_cmos_sensor(0x323B,0x02); //liukun 20151124 mirror&flip cause lSC shading problem
	//Streaming on
...
{
	 LOG_INF("liukun s5k5e8 write R_G_B gain= %x,%x,%x,%x,%x,%x\n",otp_ptr->R_gain_h,otp_ptr->R_gain_l,otp_ptr->B_gain_h,otp_ptr->B_gain_l,otp_ptr->G_gain_h,otp_ptr->G_gain_l);
