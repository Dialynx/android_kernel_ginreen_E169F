/*
	zhenglihong 20150714 add begin
*/
/*****************************************************************************
 *
 * Filename:
...
//zhenglihong 20150822 add begin
#define OV5670OTP
//zhenglihong 20150822 add end
...
static int RG_Ratio_Typical = 0x10E;//0x19f;
static int BG_Ratio_Typical = 0x10B;//0x163;
...
static int read_otp(struct otp_struct *otp_ptr)
{
	...
	//OTP into
		 ...
		 if((otp_flag & 0xc0) == 0x40) {
		   ...
		   LOG_INF("otp_info_otp_flag  = %x, addr = %x\r\n", otp_flag,addr);//bg
