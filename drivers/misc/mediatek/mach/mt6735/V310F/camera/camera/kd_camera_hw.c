...
u32 pinSet[3][8] = {
    ...
    if (On) {
	   ...
	   mdelay(2);
		...
		//wangkangmin 20151109 begin
		else if (currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_HI545_MIPI_RAW)))
        {
