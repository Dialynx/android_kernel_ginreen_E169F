...
#define FT_ESD_PROTECT  	1//for tp esd check
...
#define TPD_KEYS_DIM            	{{60,1350,20,TPD_BUTTON_HEIGH}, {180,1350,20,TPD_BUTTON_HEIGH}, {300,1350,20,TPD_BUTTON_HEIGH}}
