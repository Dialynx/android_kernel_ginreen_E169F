 ...
 */
 //huangzhaosong 201500721 s-- 
 //modify by liupeng 20151117 begin
extern int disp_bls_set_backlight(unsigned int level);
//modify by liupeng 20151117 end
static int charge_led_set_level(unsigned int level)
{
	printk("%s %d\n",__func__,level);
	if(level>0)
	{
		mt_set_gpio_mode(GPIO_VBUS_DETECT_PIN, GPIO_MODE_00);
		mt_set_gpio_dir(GPIO_VBUS_DETECT_PIN, GPIO_DIR_OUT);
		mt_set_gpio_out(GPIO_VBUS_DETECT_PIN, GPIO_OUT_ONE);
	}
	else
	{
		mt_set_gpio_mode(GPIO_VBUS_DETECT_PIN, GPIO_MODE_00);
		mt_set_gpio_dir(GPIO_VBUS_DETECT_PIN, GPIO_DIR_OUT);
		mt_set_gpio_out(GPIO_VBUS_DETECT_PIN, GPIO_OUT_ZERO);	
	}
}
//modify by liupeng 20151117 begin
static int kpd_led_set_level(unsigned int level)
{
	printk("%s %d\n",__func__,level);
	if(level>0)
	{
		...
		mt_set_gpio_out(GPIO2, GPIO_OUT_ONE);
	}
	else
	{
		mt_set_gpio_mode(GPIO2, GPIO_MODE_00);
...
//modify by liupeng 20151117 end
//huangzhaosong 201500721 e-- 
static struct cust_mt65xx_led cust_led_list_B1[MT65XX_LED_TYPE_TOTAL] = {
//huangzhaosong 201500721 s--	
	...
	{"button-backlight",  MT65XX_LED_MODE_GPIO, (long)kpd_led_set_level,{0}},
	{"lcd-backlight",     MT65XX_LED_MODE_CUST_BLS_PWM, (long)disp_bls_set_backlight,{0}},
//huangzhaosong 201500721 e-- 
	
};
static struct cust_mt65xx_led cust_led_list_A1[MT65XX_LED_TYPE_TOTAL] = {
//huangzhaosong 201500721 s--	
	{"red",               MT65XX_LED_MODE_GPIO, (long)charge_led_set_level,{0}},
	{"green",             MT65XX_LED_MODE_PMIC, MT65XX_LED_PMIC_NLED_ISINK0,{0}},
	{"blue",              MT65XX_LED_MODE_NONE, -1,{0,0,0,0,0}},
	{"jogball-backlight", MT65XX_LED_MODE_NONE, -1,{0,0,0,0,0}},
	{"keyboard-backlight",MT65XX_LED_MODE_NONE, -1,{0,0,0,0,0}},
...
//modify by liupeng 20151117 begin
	...
	flag=mt_get_gpio_in(GPIO99);	
	if(flag)
		return cust_led_list_A1;
	else
		return cust_led_list_B1;
//modify by liupeng 20151117 begin
}
