...
//tuwenzan add at 20150729 begin
#ifdef BUILD_LK
...
static int charge_led_set_level(unsigned int level)
{
	...
	if(level>0)
	{
		...
		mt_set_gpio_out(GPIO_VBUS_DETECT_PIN, GPIO_OUT_ZERO); //GPIO_OUT_ONE tuwenzan modify at 20150807
	}
	else
	{
		mt_set_gpio_mode(GPIO_VBUS_DETECT_PIN, GPIO_MODE_00);
		mt_set_gpio_dir(GPIO_VBUS_DETECT_PIN, GPIO_DIR_OUT);
		mt_set_gpio_out(GPIO_VBUS_DETECT_PIN, GPIO_OUT_ONE);//GPIO_OUT_ZERO tuwenzan modify at 20150807
	}
}

//tuwenzan add at 20150729 end
//tuwenzan modify at  20150729 begin
...
//tuwenzan modify at  20150729 end
