...
#endif
//liqiang 20150917 begin
#ifdef CONFIG_WIND_E200L_PRO
#include <mach/upmu_common.h> 
#endif
//liqiang 20150917 end
    ...
    switch(host->id){
        case 1:
            ...
            if (host->hw->flags & MSDC_SD_NEED_POWER)
				...
				//modify by liupeng 20150709  begin
                //msdc_ldo_power(on, MT6328_POWER_LDO_VMCH, VOL_3000, &g_msdc1_flash);  
				#if defined(CONFIG_VMCH_POWERON_ALLTIME)
					msdc_ldo_power(1, MT6328_POWER_LDO_VMCH, VOL_3000, &g_msdc1_flash); 
				#else
					msdc_ldo_power(on, MT6328_POWER_LDO_VMCH, VOL_3000, &g_msdc1_flash); 
				#endif
		...
		//modify by liupeng 20150709  end
	    if (on)
